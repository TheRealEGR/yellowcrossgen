...
CeladonMart2FClerk2Text::
	script_mart TM_DOUBLE_TEAM, TM_REFLECT, TM_RAZOR_WIND, TM_HORN_DRILL, TM_EGG_BOMB, TM_MEGA_PUNCH, TM_MEGA_KICK, TM_TAKE_DOWN, TM_SUBMISSION, TM_FLAMETHROWER, TM_ICE_PUNCH, TM_FIRE_PUNCH, TM_AMNESIA, TM_THUNDERPUNCH
